<?php
	...
	else
	{
		...
		$sql = "SELECT (name, email, city, state, zip, phone) FROM Contacts WHERE ((name LIKE '%$search%') AND (email LIKE '%$search%') AND (city LIKE '%$search%') AND (state LIKE '%$search%') AND (zip LIKE '%$search%') AND (phone LIKE '%$search%'))";
